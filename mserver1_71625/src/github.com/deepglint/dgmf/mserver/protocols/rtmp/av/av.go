...
func (this SampleFormat) BytesPerSample() int {
	switch this {
	case U8, U8P:
		return 1
	case S16, S16P:
...
func (this SampleFormat) String() string {
	switch this {
	case U8:
		return "U8"
	case S16:
...
func (this SampleFormat) IsPlanar() bool {
	switch this {
...
func (this ChannelLayout) String() string {
	return fmt.Sprintf("%dch", this.Count())
}
...
func (this ChannelLayout) Count() (n int) {
	for this != 0 {
		n++
		this = (this - 1) & this
	}
...
func (this CodecType) String() string {
	switch this {
	case H264:
		return "H264"
	case AAC:
...
func (this CodecType) IsAudio() bool {
	return this&codecTypeAudioBit != 0
}

func (this CodecType) IsVideo() bool {
	return this&codecTypeAudioBit == 0
}
...
func (this AudioFrame) Duration() time.Duration {
	return time.Second * time.Duration(this.SampleCount) / time.Duration(this.SampleRate)
}

// Check this audio frame has same format as other audio frame.
func (this AudioFrame) HasSameFormat(other AudioFrame) bool {
...
func (this AudioFrame) Slice(start int, end int) (out AudioFrame) {
	if start > end {
	...
	size := this.SampleFormat.BytesPerSample()
...
func (this AudioFrame) Concat(in AudioFrame) (out AudioFrame) {
	out = this
	out.Data = append([][]byte(nil), out.Data...)
