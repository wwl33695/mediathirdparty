...
import (
	...
	"github.com/deepglint/dgmf/mserver/protocols/udp"
	"github.com/golang/glog"
)

type UDPLiveInput struct {
	receiver       *udp.UDPReceiver
...
func (this *UDPLiveInput) Open(uri string, stream *core.LiveStream) {
...
func (this *UDPLiveInput) Receiving() bool {
	return this.receiverStatus
}

func (this *UDPLiveInput) Retry() bool {
	return this.retryStatus
}
func (this *UDPLiveInput) Opened() bool {
